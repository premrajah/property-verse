...
const PropertyEditForm = () => {
  ...
  useEffect(() => {
    ...
    const fetchPropertyData = async () => {
      try {
        ...
        // check rates for null, if yes make empty string
        if (propertyData.data && propertyData.data.rates) {
          const defaultRates = { ...propertyData.data.rates };
          ...
          propertyData.data.rates = defaultRates;
        }

        setFields(propertyData.data);
      } catch (error) {
        console.error("fetchPropertyData error ", error);
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error("Something went wrong");
      console.error("handle form update submit ", error);
    }
  };
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='mb-4 bg-blue-50 p-4'>
          ...
          <input
            ...
            value={fields.location.address2}
            onChange={handleChange}
          />
          <input
            type='text'
